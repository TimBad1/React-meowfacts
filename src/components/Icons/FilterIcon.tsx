...
export function FilterIcon({like}:ILikeIcon) {
    ...
    return (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 971.986 971.986" fill={like ? 'black' : 'white'} stroke='black' strokeWidth='3' strokeLinecap="round" opacity='.5'>
            <g>
